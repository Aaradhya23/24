...
function setup() {
  ...
  carGroup1 = new Group();
  logGroup1 = new Group();
  city=createSprite(width/2,1588)
  city.addAnimation("city",cityAnimation)

   
  for (var i = 0; i < 0; i++) {
   
    var bottomGrass1= createSprite(683,height-150-(i*400)-grassHeight,width,300);
...
else if((player.spt.y>height-1550 && player.spt.y>height-850)||
...
if (gameState === "win") {
 ...
 fill("green");
textSize(40);
text("congratulation! you win",width/2-250,-1700);
